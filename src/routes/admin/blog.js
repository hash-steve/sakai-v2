...
const Blog = (props) => {
    ...
    const RECORD_SOURCE = 'article';
    const COMMIT_SOURCE = RECORD_SOURCE;
            ...
            >
                <div className="admin form" style={{border: '0px solid red'}}>
                    <div className={`blog`}>
                        ...
                        <div className="column">                                
                            <div className="center">
                                ...
                                <div>
                                    <Calendar 
                                        id={`${columns[2].field}`}
                                        value={new Date(dateCreated ?? record[columns[2].field.toString()] ?? '')}
                                        dateFormat={fmt.DATE_FORMAT}
                                        onChange={(e) => setDateCreated(e.value)}
                                        showIcon
                                        showButtonBar                                        
                                        className={`input-date ${columns[2].field}`} 
                                    />
                                </div>
                            </div>
                        </div>
                        ...
                        {/* <div className="column">                                
                            <div className="center">
                                ...
                                <div>
                                    <Calendar 
                                        id={`${columns[3].field}`}
                                        value={new Date((datePublished) ?? record[columns[3].field].toString() ?? '')}
                                        dateFormat={fmt.DATE_FORMAT}
                                        onChange={(e) => setDatePublished(e.value)}
                                        showIcon
                                        showButtonBar                                        
                        ...
                        <div className="column">                                
                            <div className="center">
                                ...
                                <ToggleButton
                                    id={columns[3].field}
                                    checked={record[columns[3].field]} 
                    ...
                    <div className={`${COMMIT_SOURCE}-content-editor`}>
                        ...
                        <AdminEditor 
                            id={`${columns[1].field}`} 
                            editorValue={record[columns[1].field]}
                            onTextChange={((e) => onEditorChange(e, `${columns[1].field}`))}
                        />
                    </div>                  
                </div>
            </Dialog>
